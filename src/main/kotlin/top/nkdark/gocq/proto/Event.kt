 ...
 * 群文件上传事件
 */
data class FileUploadNoticeEvent(
        /**
         * 事件发生的时间戳
         */
        @JSONField(name = "time") val time: Long,
 ...
 * 接收到离线文件事件
 */
data class ReceivedOfflineFileNoticeEvent(
        /**
         * 事件发生的时间戳
         */
        @JSONField(name = "time") val time: Long,
 ...
 * 其他客户端在线状态变更事件
 */
data class OtherClientStatusChangeNoticeEvent(
        /**
         * 事件发生的时间戳
         */
        @JSONField(name = "time") val time: Long,
...
data class SendPrivateMsgResp(@JSONField(name = "message_id") val messageId: Int)
